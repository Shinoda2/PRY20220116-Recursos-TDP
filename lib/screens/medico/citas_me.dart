...
class MedicoCalendario extends StatefulWidget {
  const MedicoCalendario({super.key});

  @override
  State<MedicoCalendario> createState() => _MedicoCalendarioState();
}

class _MedicoCalendarioState extends State<MedicoCalendario> {

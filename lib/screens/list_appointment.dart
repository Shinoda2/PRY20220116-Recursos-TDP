          ...
          Column(
             children: [
               ...
               ListView.builder(
                 ...
                 itemBuilder: (context,index)=> AppointmentCard(appointments1[index]),
               ),
               SizedBox(height: 20,),
               Text('PROXIMAS',
                 style: TextStyle(
               ...
               ListView.builder(
                 ...
                 itemBuilder: (context,index)=> AppointmentCard(appointments2[index]),
               ),
               SizedBox(height: 20,),
               Text('PASADAS',
                 style: TextStyle(
               ...
               ListView.builder(
                 ...
                 itemBuilder: (context,index)=> AppointmentCard(appointments3[index]),
               ),
            ],
          ),
        ],
